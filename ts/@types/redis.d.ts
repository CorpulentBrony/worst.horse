...
declare module "redis" {
	...
	export interface Commands<R> {
		...
		*/
		get<T extends string | Buffer = string>(key: T, cb?: Callback<T>): R;
		GET<T extends string | Buffer = string>(key: T, cb?: Callback<T>): R;
		...
		*/
		hgetall<T>(key: string, cb: Callback<T>): R;
		...
		*/
		set<T extends string | Buffer = string>(key: T, value: T, cb?: Callback<T>): R;
		set<T extends string | Buffer = string>(key: T, value: T, flag: string, cb?: Callback<T>): R;
		set<T extends string | Buffer = string>(key: T, value: T, mode: string, duration: number, cb?: Callback<T | undefined>): R;
		set<T extends string | Buffer = string>(key: T, value: T, mode: string, duration: number, flag: string, cb?: Callback<T | undefined>): R;
		SET<T extends string | Buffer = string>(key: T, value: T, cb?: Callback<T>): R;
		SET<T extends string | Buffer = string>(key: T, value: T, flag: string, cb?: Callback<T>): R;
		SET<T extends string | Buffer = string>(key: T, value: T, mode: string, duration: number, cb?: Callback<T | undefined>): R;
		SET<T extends string | Buffer = string>(key: T, value: T, mode: string, duration: number, flag: string, cb?: Callback<T | undefined>): R;
